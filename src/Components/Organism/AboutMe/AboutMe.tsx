      ...
      <div className={`d-flex flex-row align-items-center gap-5`}>
        ...
        >
          ...
          >
            ...
            >
              <span className={style.aboutMeContainer_icon}>
                <b>
                  <PiMedalLight />
                </b>
              </span>
            ...
            <div
              onClick={() =>
                window.open(
                  "https://drive.google.com/file/d/1GPjrvwIvTTF8rW5giElUDd2aa_i64kaf/view?usp=sharing",
                  "_blank"
                )
              }
          ...
          <div className={`${style.aboutMeContainer_textAboutMe}`}>
            ¡Hola! Soy Guadalupe, <b>Desarrolladora Web Frontend</b> apasionada
